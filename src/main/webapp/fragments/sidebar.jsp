	...
	<div class="sidebar-sticky">
		<ul class="nav flex-column">
			...
			<li class="nav-item"><a class="nav-link" href="#"> <span
					data-feather="shopping-cart"></span> Defects
			</a></li>


			<li class="nav-item">
			
			<a class="nav-link" href="#dropdown_user"
			...
			<li class="nav-item"><a class="nav-link" href="#"> <span
					data-feather="bar-chart-2"></span> Settings
			</a></li>
		...
		<ul class="nav flex-column mb-2">
			<li class="nav-item"><a class="nav-link" href="#"> <span
					data-feather="file-text"></span> Code threaded Project
			</a></li>
			<li class="nav-item"><a class="nav-link" href="#"> <span
